    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <section className="relative py-20 overflow-hidden section-dark">
        ...
        <div className="container relative z-10 text-center">
          ...
          <motion.p className="mt-4 font-subtitle text-lg text-muted-foreground" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>Conoce al equipo detrás de CaliBots Kairos</motion.p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0}>
              <h2 className="mb-4 font-heading text-2xl font-bold uppercase tracking-wider">Nuestra <span className="text-gradient-teal">Esencia</span></h2>
      ...
      <section className="section-dark py-16">
        <div className="container">
          <h2 className="mb-10 text-center font-heading text-2xl font-bold uppercase tracking-wider">Nuestro <span className="text-gradient-gold">Equipo</span></h2>
      ...
      <section className="section-darker py-16">
        <div className="container">
          <h2 className="mb-10 text-center font-heading text-2xl font-bold uppercase tracking-wider">Nuestros <span className="text-gradient-crimson">Coaches</span></h2>
      ...
      <section className="section-dark py-16">
        <div className="container">
          <h2 className="mb-10 text-center font-heading text-2xl font-bold uppercase tracking-wider">Nuestro <span className="text-gradient-teal">Recorrido</span></h2>
          <div className="relative mx-auto max-w-2xl">
            <div className="absolute left-4 top-0 h-full w-0.5 bg-gradient-to-b from-secondary/50 via-primary/50 to-secondary/50 md:left-1/2 md:-translate-x-1/2" />
            {timeline.map((item, i) => (
              <motion.div key={item.phase} className="relative mb-10 pl-12 md:pl-0" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i}>
                <div className="absolute left-2 top-1 h-5 w-5 rounded-full border-4 border-secondary bg-background shadow-[0_0_10px_hsl(160_40%_45%/0.4)] md:left-1/2 md:-translate-x-1/2" />
      ...
      <section className="section-darker py-16">
        <div className="container">
          <motion.h2 className="mb-3 text-center font-heading text-2xl font-bold uppercase tracking-wider" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0}>
            ...
            {valoresFIRST.map((v, i) => {
              ...
              return (
                <motion.div key={v.slug} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i + 1}>
                  <Link to={`/valores/${v.slug}`} className="group block glass-card-hover p-6">

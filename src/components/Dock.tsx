...
function DockLabel({ children, ...rest }: { children: React.ReactNode; className?: string; isHovered?: any }) {
...
export default function Dock({
  ...
  const fixedHeight = magnification + 24;

  return (
    <div style={{ height: fixedHeight }} className="dock-outer">
      <motion.div
        onMouseMove={({ pageX }) => {
          mouseX.set(pageX);
        }}
